...
function library:CreateSettingsTab(menu)
    ...
    creditsSection:AddSeparator({text = 'Owners'});
    creditsSection:AddText({text = "nevrloose"})
    creditsSection:AddSeparator({text = 'Developers'});
    creditsSection:AddText({text = "huge.heart"})
    creditsSection:AddText({text = "rafelk20111"})
    creditsSection:AddSeparator({text = 'Lib Credits'});
